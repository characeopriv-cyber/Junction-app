...
const NEIGHBORHOODS = [
  ...
  },
  {
    ...
    amenities: {
      ...
      other: ["Trump International Golf Club Dubai (18-hole)", "CreaKids Nursery", "Radisson Dubai Damac Hills hotel"],
    },
  ...
  },
  {
    ...
    area: "Dubailand",
    sizeText: "Details coming soon",
    verified: false,
    subCommunities: [],
    amenities: { schools: [], mosques: [], churches: [], malls: [], hospitals: [], parks: [], other: [] },
    note: "Developer confirmed. Full amenity breakdown not yet verified — be the first to add it.",
  },
  {
    id: "town-square",
    name: "Town Square",
  ...
  },
  {
    ...
    sizeText: "Details coming soon",
    verified: false,
    subCommunities: ["The Springs", "The Meadows", "The Lakes"],
    amenities: { schools: [], mosques: [], churches: [], malls: [], hospitals: [], parks: [], other: [] },
    note: "Developer confirmed. Full amenity breakdown not yet verified — be the first to add it.",
  },
];
...
function NeighborhoodsView() {
  ...
  const hood = NEIGHBORHOODS.find((n) => n.id === selected);

  if (hood) {
    const totalAmenities = Object.values(hood.amenities).reduce((sum, arr) => sum + arr.length, 0);
    return (
      <div className="p-4 pb-8">
        <button onClick={() => setSelected(null)} className="flex items-center gap-1.5 mb-3 text-sm font-semibold" style={{ color: T.sub }}>
  ...
  return (
    <div className="p-4 pb-8">
      ...
      <p className="text-xs mb-4" style={{ color: T.sub }}>
        Every major Dubai community — who built it, and what's actually inside. No other UAE app lets you go this deep before you visit.
      </p>
          ...
          return (
            <button key={n.id} onClick={() => setSelected(n.id)}
              ...
              <div>
                ...
                <div className="text-[11px]" style={{ color: T.sub }}>By {n.developer}</div>
    ...
    <div style={{ background: T.paper, minHeight: "100vh", fontFamily: "'Inter', sans-serif" }}>
      ...
      {tab === "reels" ? (
        ...
        <div key={tab} className="tab-fade pb-16 md:pb-0">
          {tab === "feed" && <FeedView liveViews={liveViews} properties={properties} currentUser={currentUser} onPropertyUpdated={(updated) => setProperties((prev) => prev.map((p) => (p.id === updated.id ? updated : p)))} />}
          {tab === "services" && (
            <ServicesView
              providers={services}
          ...
          {tab === "neighborhoods" && <NeighborhoodsView />}
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-50"
        ...
        <div className="flex items-center justify-around px-1 pt-2 pb-1">
          {[
            ...
            {id:"profile",icon:UserCheck,      label:"Me",       color:"#7B8AA0"},
