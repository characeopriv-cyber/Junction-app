  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center" style={{ background: "rgba(0,0,0,.55)" }}
      ...
      <div className="w-full sm:w-[480px] sm:rounded-2xl rounded-t-2xl max-h-[92vh] overflow-y-auto" style={{ background: "#fff" }}
        ...
        <div className="h-56 relative" style={{ background: p.photo_url ? `url(${p.photo_url}) center/cover no-repeat` : `linear-gradient(135deg, ${p.grad?.[0] || "#0E2A44"}, ${p.grad?.[1] || "#163A5C"})` }}>
          ...
          {!p.photo_url && (
            <div className="absolute inset-0 flex items-center justify-center text-xs" style={{ color: "rgba(255,255,255,.6)" }}>
...
function PropertyCard({ p, liveViews, onViewDetails }) {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: p.photo_url ? `url(${p.photo_url}) center/cover no-repeat` : `linear-gradient(135deg, ${p.grad[0]}, ${p.grad[1]})`,
        }}
      >
        {p.photo_url && <div className="absolute inset-0" style={{ background: "linear-gradient(0deg, rgba(0,0,0,.45), rgba(0,0,0,.05))" }} />}
